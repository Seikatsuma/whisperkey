...
def test_term_table_fixes_known_names():
    ...
    cases = [("докрути виспер", "WhisperKey"), ("виспро.кей работает", "WhisperKey"),
             ...
             # Тот же живой корпус (256 записей, 15.08.26) — второй вариант того
             # же фонетического искажения, с лишней "т".
             ("используй многогентную систему", "многоагентную"),
             # Подтверждено независимой сверкой с Nexara (третий движок) на том же
             # аудио — не совпадение, реальное искажение "оркестратора".
             ("запусти глубокого артистратора", "оркестратора"),
             # Найдено на 15-файловом эталонном тесте против SaluteSpeech, 16.08.26.
             ("Wisper Key это первое", "WhisperKey"),
             ("что и в VisperKey сама система", "WhisperKey"),
             ("есть чат klot где я с тобой общаюсь", "Claude"),
             ("настройку игрок Q сделать другой", "Groq")]
